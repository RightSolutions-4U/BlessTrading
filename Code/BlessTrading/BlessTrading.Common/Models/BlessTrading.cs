...
{
    public partial class blesstradingContext : DbContext
    {
        public blesstradingContext()
        {
        }
        ...
        //{
        //}
        public blesstradingContext(DbContextOptions<blesstradingContext> dbContextOptions) : base(dbContextOptions)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=DESKTOP-GO81RKT\\MARS ; Database=BlessTrading; user id= mars ; password = mars;");
